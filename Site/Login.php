                        ...
                        <div class="amarelo2">
                            ...
                            <div class="offcanvas offcanvas-start bg-dark" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                                ...
                                <div class="offcanvas-body">
                                    ...
                                    <p><div class="iconx"><a class="nav-link" href="historia.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-handbag" viewBox="0 0 16 16">
...
<form method="post">
    <div class="container estica">
            <div class="login">
                <div class="col-md-3 col-sm-3 partslogin">
                    <label for="lemail" class="form-label"><h2>E-mail:</h2></label>
                    <input type="text" name="lemail" id="lemail" class="form-control" required>
                    <br>
                    <label for="senha" class="form-label"><h2>Senha:</h2></label>
                    <input type="password" name="senha" id="senha" class="form-control" required>
                    <br>
                     <input type="submit" value="Logar" class="btn btn-secondary btn-lg"></input>
                </div>
                <div class="risco">
                ...
                <div class="col-md-3 col-sm-3 partslogin">
                    ...
                    <a href="cadastro.php"><button type="button" class="btn btn-secondary btn-lg">Cadastrar</button></a>
                </div>
            </div>
        </div>
...
<?php
include('conexaoBDLOGIN.php');

if(isset($_POST['lemail']) || isset($_POST['senha'])) {

    if(strlen($_POST['lemail']) == 0) {
        echo "Preencha seu e-mail";
    } else if(strlen($_POST['senha']) == 0) {
        echo "Preencha sua senha";
    } else {

        $lemail = $mysqli->real_escape_string($_POST['lemail']);
        $senha = $mysqli->real_escape_string($_POST['senha']);

        $sql_code = "SELECT * FROM usuarioFshop WHERE email = '$lemail' AND senha = '$senha'";
